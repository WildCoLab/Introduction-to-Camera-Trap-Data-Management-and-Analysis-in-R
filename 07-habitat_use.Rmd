...
```{r ch7_7, class.source="Rmain"}
mod_dat <- left_join(total_cr, locs) # from the dplyr package
```
...
```{r ch7_21, class.source="Rmain"}
mod_dat <- left_join(monthly_obs, locs)
```
...
transient = 10*thin # How long should the "warm up" be
