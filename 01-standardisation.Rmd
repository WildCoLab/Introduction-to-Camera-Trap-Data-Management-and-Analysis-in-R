...
The convention we use in this course is the based on the [minimum data standards used by Wildlife Insights](https://www.wildlifeinsights.org/standards).

This dataset standard is composed of four different elements:
