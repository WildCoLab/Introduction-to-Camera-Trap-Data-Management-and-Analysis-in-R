...
There are two options, `epqs`**ONLY AVAILABLE FOR NORTH AMERICA**:
...
Or Amazon Web Service Terrain Tiles... available globally!
...
```{r ch4_47d, class.source="Rinfo", message=F, warning=F, echo=F, include=T}
