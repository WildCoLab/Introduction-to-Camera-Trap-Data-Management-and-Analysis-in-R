...
```{r ch4_36, eval=F, class.source="Rinfo"}
ee_check()
```

If they are - you should see something like this:

```{r ch4_37, class.source="Rinfo"}
...
```{r  ch4_40, message=F, warning=F, class.source="Rinfo"}
...
```{r ch4_55, eval=F, class.source="Rinfo"}
# Convert the dates
library(lubridate)
...
```{r ch4_56, eval=F, class.source="Rinfo"}
library(plotly)
